...
dataset_Teste = np.genfromtxt("12agoCarga_0m2aConv2a.csv", delimiter=';')
dataset_Teste = dataset_Teste.astype(float)

all_dataset = np.concatenate((dataset_Treino,dataset_Teste),axis = 0)
...
scores = accuracy_score(outputs_Treino, training_y_pred)
